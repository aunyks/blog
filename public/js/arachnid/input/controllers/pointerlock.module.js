...
class PointerLockInput extends Controller {
  ...
  connect() {
    ...
    this._domElement.ownerDocument.addEventListener('pointerlockchange', e => this.onLockChange(e))
    this._domElement.ownerDocument.addEventListener('pointerlockerror', e => console.error('Pointer Lock Error', e))
