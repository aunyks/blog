...
export default function GameEventManager({ children }) {
  const gameEventEmitter = useRef(new EventEmitter())
  return (
    <GameEventContext.Provider value={gameEventEmitter.current}>
      {children}
