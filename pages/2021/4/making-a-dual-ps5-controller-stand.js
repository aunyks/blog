...
export default function OnBalance() {
  return (
    <VideoPost
      ...
      `}</style>
      <p>
        Spent a day designing and 3D printing a stand for my Dualsense
        controllers. It's my first time modeling and printing something from
        start to finish. It's not perfect, but it looks pretty good and
        definitely gets the job done.
      </p>
      <p>
        Design inspired by{' '}
        <a href="https://www.thingiverse.com/3dxia/designs">3DXIA</a>.
      </p>
      <p>
        Music:
        <br />
