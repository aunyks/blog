...
'c1e7853f3023e1361fc96e322f9b0d16c59a48eaa646f00d928ecd8bf698d11a'
      ...
      */}
      ...
      <h3>Jump to</h3>
      <ul>
        <li><a href="#open-url-redirect">Open URL Redirect</a></li>
        <li><a href="#xss">Cross-Site Scripting (XSS)</a></li>
        <li><a href="#increasing-attack-impact">(Not) Increasing Attack Impact</a></li>
      ...
      <p>
        After messing with the open redirect URLs above, I was curious as to what the homepage of <code>trends.gab.com</code> looks like.
      </p>
      <figure>
        <img alt="The homepage of trends.gab.com." src="/img/tech/security/gab-trends-above-fold.jpg" />
        <img alt="The trends.gab.com homepage after scrolling down just below the fold, showing the latest trending articles." src="/img/tech/security/gab-trends-below-fold.jpg" />
      </figure>
      <p>
      ...
      <figure className="mb-4">
        <img alt="An example Gab trend page." src="/img/tech/security/gab-trend-example.jpg" />
        <figcaption>An example Gab trend.</figcaption>
      </figure>
      <p>
        I was curious as to how these articles get
        added to Gab as trends and learned that any authenticated user can create them. With this in mind, I wanted to see if I could perform a <a target="_blank" href="https://en.wikipedia.org/wiki/Cross-site_scripting">Cross-Site Scripting (XSS)</a> attack by crafting a webpage that injects
...
`}</CodeBlock>
      ...
      <p>
        With XSS at our disposal, we have the same control of the browser context as Gab, since we can edit <a target="_blank" href="https://www.w3.org/TR/WD-DOM/introduction.html">the DOM</a>, add cookies, redirect, etc.
      </p>
      <p>
        I'd originally tested the app to see whether I could use the XSS vulnerability to perform <a target="_blank" href="https://owasp.org/www-community/attacks/csrf">Cross-Site Request Forgery (CSRF)</a> make new posts on behalf of the user or even delete their account when they visit a malicious trend, and everything was working out
        until the modern browsers saved Gab.
      </p>
      <p>
        All of Gab's origins return wildcards in the <a target="_blank" href="https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Access-Control-Allow-Origin">Access Control Allow Origin (ACAO)</a> header,
        meaning that <em>any</em> web page can make a request to them. However, modern browsers block cross-origin requests when <code>credentials: 'include'</code> is used and the corresponding ACAO response value is a wildcard in order to prevent CSRF attacks.
        They got lucky.
      </p>
      <p>
        With control of the browser context but an inability to forge requests to the more interesting <code>gab.com</code> origin, we're left with the ability to phish Gab users for sensitive information.
        We can craft an attack such that we exfiltrate the victim's username, profile picture, IP address and more for our record.
      </p>
      <p>
      ...
      <p>
        Here's a demo where I use a malicious trend to prompt the user for their email and password to be stored for later.
        I chose prompting for brevity's sake. I could also make a fake login page that steal credentials for a more convincing scheme.
      </p>
      <figure>
        <video controls className="w-full mb-2">
      ...
      <p>
        Notice how I redirect the victim to a legitimate trend after grabbing their information. In doing this, I lessen the risk of a victim actually visiting my malicious website,
        which would raise suspicion since the site may not have any real information.
      </p>
      <p>
        I can even artificially make my trend post show in the top trends list simply by automating requests to the page. That way, I can gain more victims who think that it's a legitimate trend. This is because HTTP requests alone
        increment a trend's view counter, and views and recency are used to give priority on the trend lists.
      </p>
      <h3>Conclusion</h3>
      <p>
