...
export default () => (
  <Post
    ...
    <p>
      This is the second part in <a href="/2019/11/learning-music-theory">my series about music theory</a>. In the
          &nbsp;<a href="/2019/11/the-octave">previous post</a>, we covered musical notes and how
          consecutive notes are grouped in an octave. In this
          part, we'll cover scales.
        </p>
    <p>
    ...
    <h3>Note Distance</h3>
    <p>
      Note distance or, more commonly, "distance" is the distance in steps, or tones, between any two notes on a
      piano. Last time we covered the notes that comprise an octave. As a refresher, we have the 7 white keys and
      5 black
      keys that each play a unique note.
        </p>
    ...
    <p>
      Each of these notes has a distance of one half-step, or one semitone, from the two notes beside it. So, C# is
      one half-step, or semitone, away from the C and D right next to it.
        </p>
    <div className="keyboard">
    ...
    <p>
      E is one half-step away from the D# and F
      next to it.
        </p>
    <div className="keyboard">
      <div className="note white c4">C</div>
    ...
    <p>
      And, one whole step is two half steps. One whole step is the same as one tone, therefore a tone is two
      semitones. With this being said, D# is a whole step away from C# and F.
        </p>
    <div className="keyboard">
      <div className="note white c4">C</div>
      <div className="note c-sh4 black emphasized">C#</div>
    ...
    <h3>The Scale</h3>
    <p>
      A scale is a set of notes, called degrees in the scale, ordered by their pitch. Typically, notes in a scale
      have a type of musical cohesion
      where they just sound good together. Scales are typically identified by their root note, or tonic, and the
    ...
    <h4>C Major</h4>
    <p>
      A simple way to understand the major scale is to start on the first note in the conventional octave, C. The C
      major scale looks like this.
        </p>
    ...
    <p>
      Here, we start on C, because it's our tonic. Then, one whole step to the right is D. One whole step after D is
      E. One half step after E is F. One whole step after F is G. One whole step after G is A. One whole step after
      A is B, and one half step after B is the C in the next octave!
        </p>
    <p>
    ...
    <p>
      Where we start with D# and whole step to F. One whole step after F is G. One half step after G is G#. One
      whole step after G# is A#. One whole step after A# is C. A whole step after C is D. And, one half step after D
      is the D# in the next octave.
        </p>
    <p>
    ...
    <h3>Minor Scales</h3>
    <p>
      There are three different types of minor scales: natural, melodic, and harmonic. For the sake of simplicity,
      we'll cover the natural minor. You can read about the other minor scales in the additional reading at the end
      of the post.
        </p>
    <p>
      Like the major scale, the natural minor scale is a sequence of 8 notes consisting of the tonic in addition to
      7 notes in
      a sequence of steps in distance from the tonic. The minor scale follows the form W-H-W-W-H-W-W. Minor scales
      are also named after their tonic, like major scales.
        </p>
    ...
    <p>
      Where we start with C and move a whole step to the D. One half step after D is D#. One whole step after D# is
      F. One whole step after F is G. One half step after G is G#. One whole step after G# is A#. One whole step
      after A# is the C in the next octave.
        </p>
    ...
    <p>
      Where D# is the tonic, and F is one whole step after it. F# is one half step after F. G# is one whole step
      after F#. A# is one whole step after G#. B is one half step after A#. C# is one whole step after B, and D# is
    ...
    <p>
      Degrees in a scale are just the notes that comprise the scale. So, all the white keys from C to the next C are
      degrees in the C Major scale. In all scales, the tonic is called the first degree, the second note is called
      the second degree, the third is the third degree, and so on.
        </p>
    <p> In most <span className="underline" onClick={() => alert('The Major and Minor scales are 8 note scales.')}>8-note scales</span>, the
          1st through
          the 7th
          degrees in the scale are unique, and the 8th is the same note as the first. Sometimes, you'll even hear people
          refer to things like the 9th or 12th. To find these, just keep walking up the steps in the scale from the 8th
          (so the 9th is the same note as the 2nd but on the next octave, etc).
        </p>
    <h4>Do major and minor scales sound different?</h4>
    <p>
      I'm assuming you're asking this, because you can't hear the difference between them. <em>Yes!</em> Major
          scales
          typically have a happy, cheerful sound to them, while minor scales typically have a sadder sound.
        </p>
    <h3>What's next?</h3>
    <p>
    ...
    <p>
      <a href="https://music.utk.edu/theorycomp/courses/murphy/documents/Major+MinorScales.pdf">Major and Minor
            Scales - Dr. Barbara Murphy</a>
    </p>
  </Post>
)