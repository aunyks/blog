...
export default function ChordsP1() {
  return (
    <Post
      ...
      <p>
        This is the fourth part in <a href="/2019/11/learning-music-theory">my series about music theory</a>. In the <a href="/2019/12/key">previous post</a>, we covered key. In this
          part, we'll start covering chords.
    </p>
      <p>
      ...
      <h2>A Refresher</h2>
      <p>
        Any two musical notes have perceivable distances between them. These distances are called intervals and are measured in steps or tones.
      A sequence of notes with a pattern of distances between them is a scale. For example, major scales start on a root note, and susbsequent notes follow the pattern W-W-H-W-W-W-H. More on that <a href="/2019/11/musical-scales">here</a>.
    </p>
      <h2>What's a Chord?</h2>
      <p>
        A musical chord is a set of notes plaid simultaneously. Chords consist of a root note followed by at least one more note. Notes that comprise a chord are sometimes referred to as <i>members</i> of the chord.
      Some of the most common chords you hear contain three notes
    </p>
