...
export default function AmericanIsToRebel() {
  return (
    <Post
      ...
      Should we be dissatisfied with the status of our government, we know to wield our democratic power to cause the change they want to see.
      </p>
      <p>
      ...
      <p>
        If put in the conditions of the American revolution, these same patriots would be furious with the revolutionaries of the time. They'd call them the same names and want the British troops stationed in the colonies
      ...
      they're trying to secede from the country and start anew. This is to say that causing trouble to see a better future for more Americans <em>is</em> inherently American, by any means necessary like the founders of our country believed.
    </p>
      <p>
        <em>To be American is to fight for a better future. To be American is to rebel.</em>
      </p>
    </Post>
  )
}