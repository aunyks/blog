...
export default () => (
  <Post
    ...
    <figure className="my-2">
      <img alt="The front of the card." src="/img/misc/true-potential-card-front.jpg" />
    ...
    <figure className="my-2">
      <img alt="The back of the card." src="/img/misc/true-potential-card-rear.jpg" />
      <figcaption className="text-xs text-center"></figcaption>
    </figure>
    <p>
    ...
    <figure className="my-2">
      <img alt="The back of the card, but the card is oriented with the right side up higher than the left side for visual appeal." src="/img/misc/true-potential-card-rear-slant.jpg" />
      <figcaption className="text-xs text-center"></figcaption>
    </figure>
    <p>
