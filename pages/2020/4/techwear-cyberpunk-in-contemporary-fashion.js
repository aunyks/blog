...
export default function Techwear() {
  return (
    <Post
      ...
      <p>
        Techwear is a trend in modern streetwear characterized by modern materials, high function, and hints of urban influence. Components of techwear outfits are identified by modern materials chosen to maximize the comfort of the wearer in response to the conditions of the environment. Cold and wet environments inspire waterproof outer layers with insulating inner layers. Warmer climates inspire light and porous outer layers with moisture-wicking inner layers.
        Techwear outfits also maintain great ranges of motion, which is reminiscent of athletic wear.
    </p>
      <p>
      ...
      <figure className="my-5">
        <img className="w-full" src="/img/tech-culture/techwear-cyberpunk-sbs.jpg"
          alt="A photo of a real person in a techwear outfit next to another character from the Cyberpunk 2077 game." />
        <figcaption className="w-full text-xs mx-auto">This side-by-side embodies <a href="https://www.merriam-webster.com/dictionary/praxis">praxis</a>, where the theory is the character's cyberpunk outfit and the practice is the person's techwear outfit.</figcaption>
      </figure>
      <p>
      ...
      <p>
        <a href="https://www.youtube.com/watch?v=v9SBGfHPHi8">What is Techwear Really?</a>
      </p>
    </Post>
  )
}