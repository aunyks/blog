  ...
  return (
    <CodeSnippetPost
      ...
      <CodeSnippet title="Listen to FM Radio (GNURadio)">
        <p>
          Using GNURadio to listen to FM Radio. To change the station frequency,
          set the <code>Ch0 Frequency</code> argument of the RTL-SDR Source
          block to the desired FM station frequency. Every block's arguments can
          stay on their default values, except for those specified below.
        </p>
        <figure>
          <Diagram alt="An RTL-SDR block connects to a Rational Resampler block. The Resampler block connects to a Low Pass Filter block. The Filter connects to a WBFM block, which, itself, connects to an Audio Sink block">{`
      graph LR
      ...
      <CodeSnippet title="Animated Constellation Plot (Python)">
        <p>
          ...
          <a
            target="_blank"
            href="https://en.wikipedia.org/wiki/Constellation_diagram">
            Constellation Plot
          </a>{' '}
          visualization at a given frequency. Requires an RTL-SDR to be plugged
          in and matplotlib, numpy, and{' '}
          <a target="_blank" href="https://pypi.org/project/pyrtlsdr/">
            pyrtlsdr
          </a>{' '}
          to be installed.
        </p>
...
`}</CodeBlock>
      ...
      <CodeSnippet title="Listen to FM Radio (Python)">
        <p>
          ...
          , and{' '}
          <a target="_blank" href="https://pypi.org/project/PyAudio/">
            PyAudio
          </a>{' '}
          to listen to demodulate FM radio and play the message signal through
          the device speakers. Modified from a{' '}
          <a
            target="_blank"
            href="https://gist.github.com/edy555/08284bcbd03cc59ea9b6c49c8dd733c3">
            GitHub Gist
          </a>{' '}
          made by{' '}
          <a target="_blank" href="https://github.com/edy555">
            @edy555
          </a>
          . Requires an RTL-SDR to be plugged in and numpy, scipy, pyaudio, and{' '}
          <a target="_blank" href="https://pypi.org/project/pyrtlsdr/">
            pyrtlsdr
          </a>{' '}
          to be installed.
...
def callback(in_data, frame_count, time_info, status):
  ...
  # See these slides for more info https://inst.eecs.berkeley.edu/~cs194-26/fa17/Lectures/ConvEdgesTemplate.pdf
...
`}</CodeBlock>
      ...
      <CodeSnippet title="Animated PSD / FFT Plot (Python)">
        <p>
          ...
          <a
            target="_blank"
            href="https://en.wikipedia.org/wiki/Spectral_density#Power_spectral_density">
...
`}</CodeBlock>
      ...
      <CodeSnippet title="Read From .iq File (Python)">
        <p>
          ...
          to import I/Q samples from a file and optionally use{' '}
          <a target="_blank" href="https://matplotlib.org">
            matplotlib
          </a>{' '}
          to visualize some of the samples. Modified from a{' '}
          <a target="_blank" href="https://pysdr.org/content/iq_files.html">
            PySDR page
          </a>
          .
        </p>
...
`}</CodeBlock>
      ...
      <CodeSnippet title="Write to .iq File (Python)">
        <p>
          ...
          to export I/Q samples to a file. Modified from a{' '}
          <a target="_blank" href="https://pysdr.org/content/iq_files.html">
            PySDR page
          </a>
          .
