  ...
  return (
    ...
    >
      ...
      <ol>
        ...
        <li>
          Coil some solder around the tip of the iron.
        </li>
        <li>
          Turn on the iron and let it heat up.
        </li>
        <li>
          Wait for the flux to burn and solder to melt off.
        </li>
        <li>
          Continue rotating the iron while applying solder to any needed areas.
        </li>
        <li>
          Wipe excess solder off of the iron using the sponge.
        </li>
        <li>
